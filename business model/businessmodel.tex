\documentclass[nonflat,smallfont
% ,draftmode
]{langsci/langscibook} 
...
\renewcommand{\lsSeriesHistory}{~}
\renewcommand{\lsID}{opendata}
...
\renewcommand{\lsISBNdigital}{978-3-96110-092-7}
\renewcommand{\lsISBNsoftcover}{978-1721068708}
\BookDOI{10,5281/zenodo.1286972} 
...
That solution is evauluated ({\color{lsLightOrange}\includegraphics[height=1em]{langsci/graphics/tbls-receipt.pdf}})\todo{Shift icons to match text baseline}
...
The model presented here is the model as it was developed in 2015.\todo{This model was originally developed in 2015} At the time of writing (2018), the model has evolved. These changes will be listed in the evaluation sections. 
...
}\todo[inline]{This reads like this document was a cookbook for a business model, not a business model itself. Maybe call this section ``goal'' or ``task''?}
\langscisolution{ 
...
\end{enumerate}
\todo[inline]{The index of list items matches the index in the next enumeration?}
}
\evaluation{
...
A short version of the individual strategies for the five ``pillars'' can be found in the appendix.\todo[inline]{\textbackslash sectref to Appendix?} The particular target groups, the service packages (products, services), marketing and projected revenues are listed there. More elaborate strategic discussions can be found in the cookbook accompanying this business model. Real world data are also provided for inspection together with thes documents. 
...
\evaluation{
We still stand by this analysis. Events which have an influence here but had not been considered are the Lingua/Glossa-transition and the rise of the Open Library of Humanities; the replication crisis and calls for Open Science; the DEAL negotiations in Germany.\todo[inline]{Quickly in 5-6 words sum up the Lingua/Glossa case and DEAL negotiations for readers unaware of the situation, or provide ref to blog article describing the issues} 
}
\othersolutions{
...
Furthermore, this market analysis does not at all take into account possibilities of monetisation or analyse competitors, their strenghts and weaknesses.%TODO
...
\langscisolution{
For Language Science Press, we can identify four target groups, with different roles. Language Science Press will provide customised services and extras. At the same time, we assume that the groups will also have idealistic motivations and want to instrically support the idea of Open Access. Therefore, material ``benefits'' (e.g. in the form of physical books) are only one part of the ``customers''{}' motivation.\\
...
\todo[inline]{provide \textbackslash sectref to Appendix?}}
\evaluation{
...
A public company (\textit{AG}) requires an initial investment of 50,000 EUR. This capital was not available. \todo[inline]{Make this into a bullet or description list?}
}
...
Revenue also excludes taxes. See Appendix for details.\todo[inline]{ref to Appendix?}\todo[inline]{Explain what ``FTE'' is?}
}
...
\section{Print sales} 
\background{For every book sold in bookstores or online, a certain percentage remains with the middlemen, while another percentage goes to the publisher. The number of titles times the number of copies sold times the margin gives the total print revenue.}
\langscisolution{
  \fittable{\small
  \begin{tabular}{lrrrr}  
    \lsptoprule
...
\evaluation{In 2017, we published 26 books, not 48. We sold copies for a total of 4541 EUR + 206 GBP + 1228 USD, thus very short of the projected 24,000 EUR. The margin we calculated also did not take into account the free copies we have to provide to various libraries and archives, which cost us 3130 EUR}

\section{Book processing charges}  
\background{ 
...
\background{This is the complete calculation of all revenue and costs, based on estimates as to the number of series, the number of books, the number of downloads, etc. Also confer the spreadsheet distributed together with this model.}
\langscisolution{
\fittable{
...
\midrule
 & { \textbf{Total costs}} &  \textbf{195,780.77 €} &  \textbf{196,360.27 €} &  \textbf{218,849.41 €} &  \textbf{245,020.91 €} &  \textbf{272,609.45 €} & \textbf{~}\\
\end{tabular}
} 
...
\midrule
& \textbf{Total revenue} &  \textbf{128,000.00 €} &  \textbf{160,900.00 €} &  \textbf{196,800.00 €} &  \textbf{235,700.00 €} &  \textbf{277,600.00 €}\\
\midrule
{} & \textbf{Net result} &  \textbf{\textminus67,780.77 €} &  \textbf{\textminus35,460.27 €} &  \textbf{\textminus22,049.41 €} &  \textbf{\textminus9,320.91 €} &  \textbf{4,990.55 €}\\
\lspbottomrule
\end{tabular}
}
...
\begin{tabular}{lrrrrrrr}
\midrule
\multicolumn{5}{l}{ \textbf{Personnel planning 2016--2020 ctd.}}\\
\midrule
& & \textbf{2016} & \textbf{2017} & \textbf{2018} & \textbf{2019} & \textbf{2020} & \textbf{forw. proj.}\\
\midrule 
