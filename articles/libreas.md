...
<!-- ich (https://github.com/michaelavoigt) würde mir hier noch eine Ausführung wünschen: Was ist die offensichtliche Analogie? (etwa gemeint? "In OpenAPC tragen akadamische Einrichtungen Daten darüber zusammen, für welchen Artikel sie welche APC an den Verlag gezahlt haben. In den APC-Rechnungen werden i. d. R. lediglich Gesamtkosten aufgeführt, eine Aufschlüsselung, wie sich diese Kosten zusammensetzen, findet nicht statt.") -->
