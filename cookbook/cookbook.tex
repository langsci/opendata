...
Try your best to explicate these relations, even if they are somewhat murky. This is not about creating hierarchies or chains of commands. It is rather about making sure that everybody is on the same page about what they will be doing within the project. For instance, do authors communicate directly with the press directors, or is the communication mediated via the series editors? 
...
\node (pd) [above=of coordinator,xshift=-15mm,circle,draw=black,text width=1.3cm] {~ Press director};
...
\node (ku) [below=of libraries,text width=2cm] {Knowledge Unlatched};
\node (library1) [below=1mm of ku] {Library};
\node (library2) [left=1mm of library1] {Library};
\node (libraryetc) [right=1mm of library1] {...};
