...
\section{Governance}
Your publishing project should have a structure which allows you to ensure that scientific, financial, organisational and ethical aspects are all well handled. The organigram of Language Science Press is given in Figure \ref{fig:organigram}. 
